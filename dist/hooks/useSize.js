...
var useSize = function useSize() {
  ...
  var elementsResizeEventCallback = (0, _react.useCallback)(
    function() {
      if (isWindow.current) return;
    ...
    function() {
      ...
      if (isWindow.current) {
        ...
        if (!resizeObserver.current)
          resizeObserver.current = new _resizeObserverPolyfill2.default(
            elementsResizeEventCallback
          );
      ...
      return function() {
        ...
        else resizeObserver.current.unobserve(element.current);
      };
    },
    [ref]
  );
