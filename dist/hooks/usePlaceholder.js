...
var usePlaceholder = function usePlaceholder(ready) {
  ...
  var setContainer = (0, _react.useCallback)(function (ref) {
    ...
    Loader && (0, _reactDom.render)(_react2.default.createElement(Loader, null), placeholder.current);
    if (!ready) container.current.appendChild(placeholder.current);
  }, []);

  (0, _react.useEffect)(function () {
    if (!container.current || !placeholder.current) return;
    if (!ready) container.current.appendChild(placeholder.current);else if (ready) container.current.removeChild(placeholder.current);
  }, [ready]);
